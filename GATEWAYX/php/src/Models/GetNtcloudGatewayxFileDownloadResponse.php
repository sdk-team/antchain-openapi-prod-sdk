...
use AntChain\GATEWAYX\Models\InvokerInfo;

class GetNtcloudGatewayxFileDownloadResponse extends Model {
    protected $_name = [
        'reqMsgId' => 'req_msg_id',
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['upload_invoker'])){
            $model->uploadInvoker = InvokerInfo::fromMap($map['upload_invoker']);
        }
        return $model;
    }
    /**
