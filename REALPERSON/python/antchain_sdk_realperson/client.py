...
from antchain_sdk_realperson import models as _realperson_models
...
class Client:
    ...
    def query_irealperson_facevrf_server_ex(self, request, runtime):
        ...
        return _realperson_models.QueryIRealpersonFacevrfServerResponse().from_map(self.do_request("1.0", "di.realperson.facevrf.server.query", "HTTPS", "POST", "/gateway.do", request.to_map(), runtime))
    ...
    def create_irealperson_facevrf_server_ex(self, request, runtime):
        ...
        """
        UtilClient.validate_model(request)
        return _realperson_models.CreateIRealpersonFacevrfServerResponse().from_map(self.do_request("1.0", "di.realperson.facevrf.server.create", "HTTPS", "POST", "/gateway.do", request.to_map(), runtime))
    ...
    def exec_irealperson_facevrf_server_ex(self, request, runtime):
        ...
        """
        UtilClient.validate_model(request)
        return _realperson_models.ExecIRealpersonFacevrfServerResponse().from_map(self.do_request("1.0", "di.realperson.facevrf.server.exec", "HTTPS", "POST", "/gateway.do", request.to_map(), runtime))
    ...
    def get_irealperson_facevrf_evidence_ex(self, request, runtime):
        ...
        """
        UtilClient.validate_model(request)
        return _realperson_models.GetIRealpersonFacevrfEvidenceResponse().from_map(self.do_request("1.0", "di.realperson.facevrf.evidence.get", "HTTPS", "POST", "/gateway.do", request.to_map(), runtime))
