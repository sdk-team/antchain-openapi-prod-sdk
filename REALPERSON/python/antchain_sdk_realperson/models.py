...
class QueryIRealpersonFacevrfServerRequest(TeaModel):
    ...
    # 场景ID
    def __init__(self, auth_token=None, certify_id=None, extern_param=None, material_hash=None, outer_order_no=None, scene_id=None):
...
class QueryIRealpersonFacevrfServerResponse(TeaModel):
    ...
    # 是否通过，通过为T，不通过为F
    # 业务失败原因
    def __init__(self, req_msg_id=None, result_code=None, result_msg=None, identity_info=None, material_info=None, material_matched=None, passed=None, reason=None):
...
class CreateIRealpersonFacevrfServerRequest(TeaModel):
    ...
    # 用户的IP
    # 用户的手机号
    def __init__(self, auth_token=None, biz_code=None, cert_name=None, cert_no=None, cert_type=None, extern_param=None, facial_picture_ref=None, identity_type=None, meta_info=None, outer_order_no=None, return_url=None, scene_id=None, user_id=None, user_ip=None, user_mobile=None):
        self.auth_token = auth_token
...
class ExecIRealpersonFacevrfServerRequest(TeaModel):
    ...
    # 用户的IP
    # 用户的手机号（或其哈希值）
    def __init__(self, auth_token=None, cert_name=None, cert_no=None, cert_type=None, extern_param=None, facial_picture_auth=None, facial_picture_ref=None, identity_type=None, outer_order_no=None, scene_id=None, user_id=None, user_ip=None, user_mobile=None):
        self.auth_token = auth_token
        self.cert_name = cert_name
        self.cert_no = cert_no
        self.cert_type = cert_type
...
class GetIRealpersonFacevrfEvidenceResponse(TeaModel):
    ...
    def __init__(self, req_msg_id=None, result_code=None, result_msg=None, certify_id=None, onchain_id=None, onchain_status=None, pdf_content=None, pdf_expired=None):
        self.req_msg_id = req_msg_id
        self.result_code = result_code
        self.result_msg = result_msg
        self.certify_id = certify_id
